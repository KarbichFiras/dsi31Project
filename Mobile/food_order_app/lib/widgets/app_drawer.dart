...
class AppDrawer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    onTap: (){
    print('Shop');
    Navigator.push(context, MaterialPageRoute(builder:(cnx){return RestauarantsOverviewScreen();}));
    },
    ),
    ListTile(
    title: Text('Food'),
    ...
    onTap: (){
    print('Orders');
    Navigator.push(context, MaterialPageRoute(builder:(cnx){return CartScreen();}));
    },
    ),
    ListTile(
    title: Text('Logout'),
